...
class Createc_Controller:
    ...
    def scan_image(self,
        ...
        # print(GainX, self.offset_nm[0], Xpiezoconst, self.offset_nm[1], Ypiezoconst)
    ...
    def diss_manipulation(self, 
        ...
        self.stm.setparam('Vpoint1.V', mvoltage)   # add pulse
        self.stm.setparam('Vpoint3.V', mvoltage)
