...
from REACTRL.env_modules.net_framework_curr import *
from REACTRL.env_modules.signal_conv import *
from REACTRL.img_modules.curr_data import train_loader, test_loader
from boss.bo.bo_main import BOMain
from boss.pp.pp_main import PPMain
from datetime import datetime
import pandas as pd

def func(X, model=None, method='resnetbase'):
    lr = 10 ** X[0, 0]
    ...
    if model is None:
        ...
        if method=='lstm':
            ...
            model = CNN()
        elif method=='resnetbase':
            model = ResNetBaseline(in_channels=1,
                        num_pred_classes=2)
        else:
            method = 'tscl'
            model = TimeSeriesClassifier(input_size, hidden_size, num_classes)
